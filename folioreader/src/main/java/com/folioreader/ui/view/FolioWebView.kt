    ...
    fun onTextSelectionItemClicked(id: Int, selectedText: String?) {
        ...
        when (id) {
            R.id.copySelection -> {
                ...
                Toast.makeText(context, context.getString(R.string.DONOTALLOWED), Toast.LENGTH_SHORT)
            }
            R.id.shareSelection -> {
                Log.d(LOG_TAG, "-> onTextSelectionItemClicked: shareSelection -> $selectedText")
                //UiUtil.share(context, selectedText)
                Toast.makeText(context, context.getString(R.string.DONOTALLOWED), Toast.LENGTH_SHORT).show()
            }
